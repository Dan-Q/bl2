...
var _slimJs = __webpack_require__(329);
...
function saveStatus() {
  var containers = [].concat(_toConsumableArray(document.querySelectorAll('bl-template .renderable')));
  var status = containers.map(function (el) {
    return el.id + '=' + el.attributes.showing.value;
  }).join('&');
  window.location.hash = status;
}
function loadStatus() {
  var status = window.location.hash.replace(/^#/, '').split('&').map(function (i) {
    return i.split('=', 2);
  });
...
function markLinksToCurrentPage() {
  var currentPages = [].concat(_toConsumableArray(document.querySelectorAll('bl-template .renderable'))).map(function (container) {
    return container.attributes.showing.value;
  });
  var currentPageIdentities = currentPages.filter(function (id) {
    return id != '';
  }).map(function (id) {
    var block = document.querySelector('bl-content #' + id);
    if (!block) return '';
    return block.attributes.identifyas ? block.attributes.identifyas.value : id;
  });
  var links = [].concat(_toConsumableArray(document.querySelectorAll('a')));
  links.forEach(function (a) {
    return a.classList.remove('current');
  });
  links.filter(function (a) {
    return currentPageIdentities.includes(a.attributes.href.value);
  }).forEach(function (a) {
...
window.addEventListener('load', function (e) {
  ...
  document.querySelectorAll('bl-template .renderable').forEach(function (e) {
    return e.render();
  });
  saveStatus();
  markLinksToCurrentPage();
...
Slim.tag('bl-container', '', function (_Slim) {
  _inherits(BlContainer, _Slim);

  function BlContainer() {
    _classCallCheck(this, BlContainer);

    return _possibleConstructorReturn(this, (BlContainer.__proto__ || Object.getPrototypeOf(BlContainer)).apply(this, arguments));
  }

  _createClass(BlContainer, [{
    key: 'loadContent',
    value: function loadContent(id) {
      this.attributes.showing.value = id;
      this.innerHTML = '';
      if (!id || id == '') return;
      var originalNode = document.querySelector('bl-content #' + id);
      if (!originalNode) return;
      var newNode = document.querySelector('bl-content #' + id).cloneNode(true);
...
Slim.tag('bl-content', '', function (_Slim) {
  _inherits(BlContent, _Slim);

  function BlContent() {
    _classCallCheck(this, BlContent);

    return _possibleConstructorReturn(this, (BlContent.__proto__ || Object.getPrototypeOf(BlContent)).apply(this, arguments));
  }

  _createClass(BlContent, [{
    key: 'render',
    value: function render() {}
  }]);
...
Slim.tag('bl-floater', '', function (_Slim) {
  _inherits(BlFloater, _Slim);

  function BlFloater() {
    _classCallCheck(this, BlFloater);

    return _possibleConstructorReturn(this, (BlFloater.__proto__ || Object.getPrototypeOf(BlFloater)).apply(this, arguments));
  }

  _createClass(BlFloater, [{
    key: 'onAdded',
    value: function onAdded() {
...
Slim.tag('bl-grid', '', function (_Slim) {
  ...
  function BlGrid() {
    _classCallCheck(this, BlGrid);

    return _possibleConstructorReturn(this, (BlGrid.__proto__ || Object.getPrototypeOf(BlGrid)).apply(this, arguments));
  }
...
Slim.tag('bl-menu', '', function (_Slim) {
  _inherits(BlMenu, _Slim);

  function BlMenu() {
    _classCallCheck(this, BlMenu);

    return _possibleConstructorReturn(this, (BlMenu.__proto__ || Object.getPrototypeOf(BlMenu)).apply(this, arguments));
  }
...
Slim.tag('bl-padded-block', '', function (_Slim) {
  _inherits(BlPaddedBlock, _Slim);

  function BlPaddedBlock() {
    _classCallCheck(this, BlPaddedBlock);

    return _possibleConstructorReturn(this, (BlPaddedBlock.__proto__ || Object.getPrototypeOf(BlPaddedBlock)).apply(this, arguments));
  }

  _createClass(BlPaddedBlock, [{
    key: 'render',
    value: function render() {}
  }]);

  return BlPaddedBlock;
}(Slim));
...
Slim.tag('bl-template', '', function (_Slim) {
  _inherits(BlTemplate, _Slim);

  function BlTemplate() {
    _classCallCheck(this, BlTemplate);

    return _possibleConstructorReturn(this, (BlTemplate.__proto__ || Object.getPrototypeOf(BlTemplate)).apply(this, arguments));
  }

  _createClass(BlTemplate, [{
    key: 'onAdded',
    value: function onAdded() {
...
/***/ })
/******/ ]);
//# sourceMappingURL=bodlanes2.js.map